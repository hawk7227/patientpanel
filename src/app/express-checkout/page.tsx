      ...
      <div className="h-full max-w-[430px] mx-auto flex flex-col" style={{ paddingTop: "env(safe-area-inset-top, 4px)", paddingBottom: "env(safe-area-inset-bottom, 4px)", paddingLeft: "16px", paddingRight: "16px" }}>
        ...
        <div className="text-center pt-3 pb-2 flex-shrink-0">
          ...
          <div className="flex items-center justify-center gap-2 mb-1">
            <div className="w-7 h-7 bg-[#2dd4a0]/20 rounded-lg flex items-center justify-center">
              <Shield size={16} className="text-[#2dd4a0]" />
            </div>
            <span className="text-white font-bold text-[17px] tracking-tight">Medazon <span className="text-[#2dd4a0]">Health</span></span>
          </div>
          {/* Subtitle */}
        ...
        {/* ═══ WELCOME + BADGE + DOCTOR CARD ═══ */}
        <div className="flex items-start justify-between pb-1.5 flex-shrink-0">
          <div className="flex-1">
            {patient.source !== "new" && patient.firstName ? (
              <>
                <div className="flex items-center gap-2 mb-1"><Zap size={12} className="text-[#f97316]" /><span className="text-[#f97316] font-semibold text-[11px]">Welcome back, {patient.firstName}!</span></div>
              ...
              <>
                <div className="flex items-center gap-2 mb-1"><Shield size={12} className="text-[#2dd4a0]" /><span className="text-[#2dd4a0] font-semibold text-[11px]">Private & Discreet Care</span></div>
                <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border-2 border-[#2dd4a0]/40 bg-[#2dd4a0]/10">
                  <Lock size={10} className="text-[#2dd4a0]" />
                  <span className="text-[#2dd4a0] font-black text-[10px] uppercase tracking-wider">100% Confidential</span>
                </div>
              </>
            )}
        ...
        {/* ═══ BOOK YOUR REQUEST HEADING ═══ */}
        <div className="text-center py-2">
          <h2 className="text-white text-[18px] font-black tracking-wide">Book Your Request</h2>
        </div>
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden pb-1 space-y-2 min-h-0" style={{ scrollbarWidth: "none" }}>
          ...
          {activeGuideStep === 2 && (
            <div className={`rounded-xl bg-[#11161c] p-4 space-y-3 transition-all ${activeOrangeBorder}`} style={{ animation: "fadeInStep 0.7s cubic-bezier(0.22, 1, 0.36, 1) both" }}>
              <div className="flex items-center justify-between">
                <button onClick={() => { setReason(""); setChiefComplaint(""); saveAnswers({ reason: "", chiefComplaint: "" }); }} className="text-gray-500 text-[10px] hover:text-white transition-colors">← Back</button>
                <div className="flex items-center gap-2"><span className="text-[11px] font-black text-[#f97316] bg-[#f97316]/15 w-6 h-6 rounded-full flex items-center justify-center">2</span><span className="text-white text-[15px] font-black uppercase tracking-wide">Briefly Describe Your Symptoms</span></div>
                <div className="w-8" />
              </div>
          ...
          {activeGuideStep === 3 && (
            <div className={`rounded-xl bg-[#11161c] p-4 space-y-2 transition-all ${activeOrangeBorder}`} style={{ animation: "fadeInStep 0.7s cubic-bezier(0.22, 1, 0.36, 1) both" }}>
              <div className="flex items-center justify-between">
                <button onClick={() => { setChiefComplaint(""); setSymptomsDone(false); saveAnswers({ chiefComplaint: "", symptomsDone: false }); }} className="text-gray-500 text-[10px] hover:text-white transition-colors">← Back</button>
                <div className="flex items-center gap-2"><span className="text-[11px] font-black text-[#f97316] bg-[#f97316]/15 w-6 h-6 rounded-full flex items-center justify-center">3</span><span className="text-white text-[10px] font-semibold uppercase tracking-wider">Preferred Pharmacy</span></div>
                <div className="w-8" />
              </div>
          ...
          {activeGuideStep === 4 && (
              <div className={`rounded-xl bg-[#11161c] p-4 space-y-3 transition-all ${activeOrangeBorder}`} style={{ animation: "fadeInStep 0.7s cubic-bezier(0.22, 1, 0.36, 1) both" }}>
                <div className="flex items-center justify-between">
                  <button onClick={() => { setPharmacy(""); setPharmacyInfo(null); setPharmacyAddress(""); saveAnswers({ pharmacy: "", pharmacyInfo: null, pharmacyAddress: "" }); }} className="text-gray-500 text-[10px] hover:text-white transition-colors">← Back</button>
                  <div className="flex items-center gap-2"><span className="text-[11px] font-black text-[#f97316] bg-[#f97316]/15 w-6 h-6 rounded-full flex items-center justify-center">4</span><span className="text-white text-[10px] font-semibold uppercase tracking-wider">Select Visit Type</span></div>
                  <div className="w-8" />
                </div>
