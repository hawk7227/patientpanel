<Head>
  ...
  {/* =======================================================
     URGENT CARE — PAGE TITLE, DESCRIPTION, CANONICAL
  ======================================================== */}
  <title>Instant Virtual Urgent Care in Florida — Medazon Health</title>

  <meta
    name="description"
    content="Fast, private virtual urgent care in Florida. Licensed clinicians evaluate symptoms for cold/flu, UTI concerns, sinus infections, nausea, rashes, pink eye, allergies, and more."
  />
  ...
  {/* =======================================================
     1. MEDICAL BUSINESS (PRIMARY ENTITY)
  ======================================================== */}
  ...
  {/* =======================================================
     2. MEDICAL WEB PAGE — URGENT CARE PAGE
  ======================================================== */}
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
  {
    "@context": "https://schema.org",
  ...
  {/* =======================================================
     3. BREADCRUMB LIST — URGENT CARE NAVIGATION
  ======================================================== */}
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
  {
    "@context": "https://schema.org",
  ...
  {/* =======================================================
     4. MEDICAL CONDITIONS (URGENT CARE CONDITIONS)
  ======================================================== */}
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
  [
    {
  ...
  {/* =======================================================
     5. MEDICAL PROCEDURE — URGENT CARE EVALUATION
  ======================================================== */}
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
  {
    "@context": "https://schema.org",
  ...
  {/* =======================================================
     7. ITEMLIST — SMART SEARCH SYMPTOM INDEX
  ======================================================== */}
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
  {
    "@context": "https://schema.org",
  ...
  {/* =======================================================
     8. SEARCHACTION — FOR SYMPTOM SMART SEARCH
  ======================================================== */}
  <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `
  {
    "@context": "https://schema.org",
